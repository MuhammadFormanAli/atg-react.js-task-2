...
function App() {
  ...
  if (loading) {
    return <div className='w-100 py-5 h-100 d-flex align-items-center justify-content-center'><Spinner animation="border" variant="info" /></div>;
  }
  ...
  const a = {user,handleImageError,handleImageLoad,imageLoading,imageError}
 

  return (
    <div className='d-flex justify-content-between p-5 gap-5 h-100 '>
      {/* section to show all the users */}
      <AllUsers users={users} handleShowUserInfo={handleShowUserInfo} handleImageError={handleImageError} handleImageLoad={handleImageLoad} />
